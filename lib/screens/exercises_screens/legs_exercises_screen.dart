...
class LegsExercisesScreen extends StatefulWidget {
  const LegsExercisesScreen({super.key});

  @override
  State<LegsExercisesScreen> createState() => _LegsExercisesScreenState();
}

class _LegsExercisesScreenState extends State<LegsExercisesScreen> {
  final String _collectionName = "legs_exercises";
